        ...
        <div class="row g-0">
            <aside class="col-lg-3 col-xl-2 sidebar-panel p-3 p-lg-4 d-flex flex-column">
                ...
                <nav class="nav flex-column gap-2">
                    ...
                    <a href="{{ route('kepalasbum.profil') }}" class="sidebar-link active">
            ...
            <main class="col-lg-9 col-xl-10 p-3 p-md-4 p-xl-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-start gap-3 mb-4">
                    <div>
                        ...
                        <h1 class="page-heading">Profil Kepala SBUM</h1>
                    </div>
                ...
                <div class="card intro-card shadow-none mb-5">
                    <div class="card-body p-4 p-lg-5">
                        <h2 class="fs-5 fw-semibold mb-3">Kelola biodata dan akun Kepala SBUM</h2>
