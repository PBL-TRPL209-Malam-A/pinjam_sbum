...
@section('page_caption', 'PIC')
@section('page_heading', 'Profil PIC')
...
<div class="card banner-card shadow-none mb-4">
    <div class="card-body p-4 p-lg-5">
        <h2 class="fs-5 fw-semibold mb-2 text-main">Kelola biodata dan akun PIC</h2>
...
<div class="row g-4">
    ...
    <div class="col-lg-3">
        <div class="profile-sidebar">
            ...
            <div class="text-secondary small mb-3">PIC Fasilitas</div>
            <div>
            ...
            <div class="detail-list">
                ...
                <div class="detail-list-item d-flex flex-column">
                    ...
                    <span class="fw-semibold text-main">PIC Fasilitas / Ruangan</span>
                </div>
                <div class="detail-list-item d-flex flex-column">
    ...
    <div class="col-lg-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-6">
                <div class="stat-box">
                    <div class="stat-label">Kesiapan Selesai</div>
...
<div class="modal fade" id="editProfilModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg" style="background-color: #fffdfa;">
            ...
            <form action="{{ route('pic.profil.update') }}" method="POST">
                @csrf
                @method('PUT')
