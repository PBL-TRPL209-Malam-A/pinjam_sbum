...
<div class="card banner-card shadow-none mb-4">
    <div class="card-body p-4 p-lg-5">
        <h2 class="fs-5 fw-semibold mb-2 text-main">Kelola biodata dan akun admin</h2>
...
<div class="row g-4">
    ...
    <div class="col-lg-3">
        <div class="profile-sidebar">
            ...
            <div class="text-secondary small mb-3">Administrator SBUM</div>
            <div>
            ...
            <div class="detail-list">
                ...
                <div class="detail-list-item d-flex flex-column">
                    ...
                    <span class="fw-semibold text-main">Administrator SBUM</span>
                </div>
                <div class="detail-list-item d-flex flex-column">
        ...
        <div class="card border-0 rounded-4 p-4 shadow-none" style="background: transparent; border: 1px solid var(--line) !important;">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control profile-input" value="{{ $user->nama_lengkap }}" readonly>
                </div>
                <div class="col-md-6">
                    <label class="form-label text-secondary small fw-semibold">NIP</label>
                    <input type="text" class="form-control profile-input" value="{{ $user->nim }}" readonly>
                </div>
                <div class="col-md-6">
                    <label class="form-label text-secondary small fw-semibold">Tempat, Tanggal Lahir</label>
                    <input type="text" class="form-control profile-input" value="Batam, 12 April 2004" readonly>
                </div>
                <div class="col-md-6">
                    <label class="form-label text-secondary small fw-semibold">Jenis Kelamin</label>
                    <input type="text" class="form-control profile-input" value="Laki-laki" readonly>
                </div>
            </div>
