        ...
        <div class="row g-0">
            ...
            <aside class="col-lg-3 col-xl-2 sidebar-panel p-3 p-lg-4 d-flex flex-column">
                ...
                <nav class="nav flex-column gap-1">
                    <a href="{{ route('pamdal.dashboard') }}" class="sidebar-link {{ request()->routeIs('pamdal.dashboard') ? 'active' : '' }}">
                        <span class="sidebar-dot"></span><span>Dashboard</span>
                    </a>
                    <a href="{{ route('pamdal.monitoring') }}" class="sidebar-link {{ request()->routeIs('pamdal.monitoring*') ? 'active' : '' }}">
                        <span class="sidebar-dot"></span><span>Monitoring Hari Ini</span>
                    </a>
                    <a href="{{ route('pamdal.profil') }}" class="sidebar-link {{ request()->routeIs('pamdal.profil*') ? 'active' : '' }}">
            ...
            <main class="col-lg-9 col-xl-10 p-3 p-md-4 p-xl-4 d-flex flex-column">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-start gap-3 mb-4">
                    <div>
                        <div class="page-caption">@yield('page_caption', 'Pamdal')</div>
