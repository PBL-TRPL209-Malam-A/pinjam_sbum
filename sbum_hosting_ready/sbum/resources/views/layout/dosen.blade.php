        ...
        <div class="row g-0">
            ...
            <aside class="col-lg-3 col-xl-2 sidebar-panel p-3 p-lg-4 d-flex flex-column">
                ...
                <nav class="nav flex-column gap-1">
                    ...
                    <a href="{{ route('dosen.verifikasi-peminjaman') }}" class="sidebar-link {{ request()->routeIs('dosen.verifikasi-peminjaman') ? 'active' : '' }}">
            ...
            <main class="col-lg-9 col-xl-10 p-3 p-md-4 p-xl-4 d-flex flex-column">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-start gap-3 mb-4">
                    <div>
                        <div class="page-caption">@yield('page_caption', 'Dosen Penanggung Jawab')</div>
                        <h1 class="page-heading">@yield('page_heading')</h1>
                    </div>

                    <div class="d-flex align-items-center gap-3 w-100 w-md-auto">
                        <input type="text" class="form-control search-input" placeholder="Cari pengajuan">
